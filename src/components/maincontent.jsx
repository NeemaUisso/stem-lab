...
const MainContent = ({ toggleSidebar }) => {
  return (
    <div className="flex-grow-1">
      <nav className="navbar navbar-light fixed-top" style={{backgroundColor: '#ffffffff'}}>
        <i
          className="bi bi-list-stars bg-primary ps-2 pe-2 pt-1 pb-1 rounded ms-2 text-white"
                        ...
                        return (
                          <div className="col-lg-4" key={colIdx}>
                            <div className="card">
                              ...
                              />
                              <div className="card-body text-white py-2" style={{backgroundColor: '#050020ff'}}>
